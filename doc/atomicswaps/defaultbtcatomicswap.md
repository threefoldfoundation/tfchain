#  Cross chain atomic swap walkthrough using the Bitcoin Core client.

## required tools  
In order to execute atomic swaps as described in this document, you need to run the core tfchain daemon and client, available from https://github.com/threefoldfoundation/tfchain/releases, the [Bitcoin Core full node client](https://bitcoin.org/en/bitcoin-core/) and the atomic swap tools that are available at https://github.com/rivine/decredatomicswap/releases. 
